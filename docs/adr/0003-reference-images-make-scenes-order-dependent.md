...
**Superseded by [ADR-0004](0004-one-reference-picture-per-scene.md) on 2026-09-08.** The probe it was waiting on showed that an attached setting never transfers, so the order-dependence it accepted bought nothing and was removed before any Run used it. The Lead half stands.
