...
This repo tracks issues as local markdown, so a "label" is written as the value of the `Status:` line near the top of the issue file (see `issue-tracker.md`), not as a tracker label.
